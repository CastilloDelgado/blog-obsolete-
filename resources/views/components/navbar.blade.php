<nav class="md:flex md:justify-between md:items-center bg-black text-white p-5">
  <div>
    <a href="/">
  ...
  <div class="mt-8 md:mt-0 flex items-center">
    ...
    <a href="#newsletter" class="hover:scale-105 font-sans bg-white text-black  ml-3 text-sm   py-2 px-3">
      Newsletter
    </a>
  </div>
</nav>